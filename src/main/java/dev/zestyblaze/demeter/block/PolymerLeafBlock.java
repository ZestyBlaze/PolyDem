...
public abstract class PolymerLeafBlock extends Block implements PolymerBlock {
    public PolymerLeafBlock(Properties properties) {
        super(properties);
    }

    public static SimpleFastBlock create(Properties settings) {
        if (PolymerBlockResourceUtils.getBlocksLeft(BlockModelType.LEAVES) > 0
    ...
    protected static class TexturedBlock extends SimpleFastBlock implements PolymerTexturedBlock {
        private final BlockState state;
        public TexturedBlock(Properties settings) {
            super(settings);
            this.state = PolymerBlockResourceUtils.requestBlock(BlockModelType.LEAVES, PolymerBlockModel.of(
    ...
    protected static class VirtualBlock extends SimpleFastBlock implements FactoryBlock {
